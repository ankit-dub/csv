...
public class LoanRestructreApplication {
    private static final Logger LOG = LoggerFactory.getLogger(LoanRestructreApplication.class);
    private static final String Excel_FILE = "/home/ankit/Downloads/loanRestructre/src/main/resources";

    public static void main(String[] args) throws IOException, DocumentException, SQLException {

        LoanRestructreApplication thymeleaf2Pdf = new LoanRestructreApplication();
